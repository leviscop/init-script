...
curl -s https://github.com/leviscop/init-script/raw/main/daemon.json -o /etc/docker/daemon.json
...
curl -s https://github.com/leviscop/init-script/raw/main/.stignore -o /volume/.stignore
mkdir -p /volume/proxy
curl -s https://github.com/leviscop/init-script/raw/main/traefik.toml -o /volume/proxy/traefik.toml
